...
data = df[['病人ID','临床结局 ', '血_单核细胞(%)','血_国际标准化比值','血_中性粒细胞(#)',
'血_白蛋白','血_超敏C反应蛋白','血_血小板计数','血_尿素','血_乳酸脱氢酶']]
...
for train_index, test_index in kf.split(X):
    ...
    model.fit(X[train_index], Y[train_index], epochs=90 , batch_size=64,
...
print('TA 1D-CNN (clinical outcome):')
...
print('TA 1D-CNN:',confusion_matrix)
